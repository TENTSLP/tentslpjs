...
var name = "My NFT1 Group";
var ticker = "NFT1 Group";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                initialTokenQtyBN = new bignumber_js_1.BigNumber(initialTokenQty);
                // 3) Set private keys
                balances.nonSlpUtxos.forEach(function (txo) { return txo.wif = fundingWif; });
                return [4 /*yield*/, bitboxNetwork.simpleNFT1ParentGenesis(name, ticker, initialTokenQtyBN, documentUri, documentHash, tokenReceiverAddress, batonReceiverAddress, bchChangeReceiverAddress, balances.nonSlpUtxos)];
            case 2:
                genesisTxid = _a.sent();
...
//# sourceMappingURL=4-genesis-token-type-NFT1-parent.js.map