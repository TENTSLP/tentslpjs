...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var BITBOX, fundingAddress, fundingWif, bchChangeReceiverAddress, tokenId, burnAmount, logger, RpcClient, connectionString, rpc, slpValidator, bitboxNetwork, tokenInfo, tokenDecimals, balances, amount, inputUtxos, sendTxid;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    amount = (new bignumber_js_1.BigNumber(burnAmount)).times(Math.pow(10, tokenDecimals));
                    ...
                    return [4 /*yield*/, bitboxNetwork.simpleTokenBurn(tokenId, amount, inputUtxos, bchChangeReceiverAddress)];
                case 3:
                    sendTxid = _a.sent();
...
//# sourceMappingURL=10-burn-token.js.map