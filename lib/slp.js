...
var Slp = /** @class */ (function () {
    ...
    Slp.prototype.processUtxosForSlpAbstract = function (utxos, validator) {
        return __awaiter(this, void 0, void 0, function () {
            var utxos_1, utxos_1_1, txo, slpMsgBuf, txn, txn, txnBuf, t, vout, e_6_1, result, tokenTxoCount, id, batonTxoCount, id;
            var e_6, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!utxos_1_1.done) return [3 /*break*/, 8];
                        txo = utxos_1_1.value;
                        slpMsgBuf = void 0;
                        if (!txo.txBuf) return [3 /*break*/, 2];
                        txn = index_1.Primatives.Transaction.parseFromBuffer(txo.txBuf);
                        slpMsgBuf = Buffer.from(txn.outputs[0].scriptPubKey);
                        return [3 /*break*/, 5];
                    case 2:
                        if (!(!txo.tx || !txo.tx.vout || !txo.tx.vout[0].n)) return [3 /*break*/, 4];
                        return [4 /*yield*/, validator.getRawTransactions([txo.txid])];
                    case 3:
                        txn = (_b.sent())[0];
                        txnBuf = void 0;
                    ...
                    case 4:
                        ...
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this.applyInitialSlpJudgement(txo, slpMsgBuf)];
                    case 6:
                        _b.sent();
                    ...
                    return [4 /*yield*/, this.applyFinalSlpJudgement(utxos, validator)];
                    case 12:
                        // 2) Cast final SLP judgement using the supplied async validator
                        _b.sent();
        ...
        try {
            ...
            for (var utxos_2 = __values(utxos), utxos_2_1 = utxos_2.next(); !utxos_2_1.done; utxos_2_1 = utxos_2.next()) {
                ...
                if (!txo.satoshis && txo.value && typeof txo.value === "number") {
                    txo.satoshis = Math.floor(txo.value * Math.pow(10, 8));
                }
    ...
    Slp.prototype.applyFinalSlpJudgement = function (utxos, validator) {
        return __awaiter(this, void 0, void 0, function () {
            var validSLPTx, getNftParentId, _a, _b, _i, txo, _c, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, validator.validateSlpTransactions(__spread(new Set(utxos.filter(function (txOut) {
                    ...
                    case 1:
                        ...
                        getNftParentId = function (tokenIdHex) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, validator.getRawTransactions([tokenIdHex])];
                                    case 1:
                                        txnhex = (_a.sent())[0];
                                        tx = index_1.Primatives.Transaction.parseFromBuffer(Buffer.from(txnhex, "hex"));
                                        return [4 /*yield*/, validator.getRawTransactions([tx.inputs[0].previousTxHash])];
                                    case 2:
